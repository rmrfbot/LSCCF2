...
void full_auton() {
  ...
  // Loader of
  pros::ADIDigitalIn loader_piston('A');

 // From corner of parking spot
 // Move forward 38.5 inches
  ...
  // start conveyor and run for 2.5 seconds
  conveyor.move(127);
  pros::delay(2500);
  conveyor.move(0);

  // Move backwards towards Goal 40 inches
